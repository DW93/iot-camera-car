...
void setup()
{
  ...
  //LiquidCrystal lcd(18, 19, 14, 15, 16, 17);  //setup lcd pins, using analog A0-A5 pins / (digital pins 14 to 19)
  //lcd = LiquidCrystal(18, 19, 14, 15, 16, 17); // reinitialize LCD, need this for LCD to work on galileo
  lcd.begin(16, 2);

  //Setup all pins being used by the arduino sketch and the xdk app for both to work at same time, dont declare ultrasonic distance sensor sensor pins or the sensors wont work
